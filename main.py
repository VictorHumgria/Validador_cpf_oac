...
def validar_cpfs():
    ...
    if cpfs_lidos: 
        ...
        messagebox.showinfo("Resultado", "Nenhum CPF lido.")

def validar_cpf_manual():
    cpf_manual = simpledialog.askstring("Entrada de CPF", "Digite um CPF para validar:")
    
    if cpf_manual and len(cpf_manual) == 11 and cpf_manual.isdigit():
        output_area.delete(1.0, tk.END)
        ...
        messagebox.showinfo("Erro", "CPF inválido. Insira um CPF com 11 dígitos numéricos.")
...
def filtrar_mensagens(output):
    ...
    for linha in output.splitlines():
        ...
        if ("MARS 4.5  Copyright 2003-2014 Pete Sanderson and Kenneth Vollmar" not in linha and
            "Digite o CPF (somente números):" not in linha):
